...
class RepositorioConsultaVentas extends RepositorioConsulta
  ...
  @override
  Future<List<VentaDto>> obtenerHistoricoVentas(DateTime fechaReporte) async {
    ...
    var result = await query(sql: sql, params: [fechaReporte.millisecondsSinceEpoch]);
    ...
    if (result.isNotEmpty) {
      ...
      result = await query(sql: sql, params: [venta.uid.toString()]);
