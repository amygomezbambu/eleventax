...
class Change {
  ...
  set hlc(String value) {
    if (value.isEmpty) {
      throw SyncEx(
        tipo: TiposSyncEx.parametrosIncorrectos,
        message: 'El HLC no puede estar vacio',
      );
    }
  ...
  void _setDataset(String value) {
    if (value.isEmpty) {
      throw SyncEx(
        tipo: TiposSyncEx.parametrosIncorrectos,
        message: 'El dataset no puede estar vacio',
      );
    }
  ...
  void _setColumn(String value) {
    if (value.isEmpty) {
      throw SyncEx(
        tipo: TiposSyncEx.parametrosIncorrectos,
        message: 'El nombre de la columna no puede estar vacio',
      );
    }
  ...
  void _setRowId(String value) {
    if (value.isEmpty) {
      throw SyncEx(
        tipo: TiposSyncEx.parametrosIncorrectos,
        message: 'El identificador de renglon no puede estar vacio',
      );
    }
  ...
  void _setVersion(int value) {
    if (value <= 0) {
      throw SyncEx(
          ...
          message: 'Se debe proporcionar una version de cambio valida');
    }
